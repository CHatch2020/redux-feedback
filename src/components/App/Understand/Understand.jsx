...
function Understand() {
  ...
  return (
    <div className="text-center py-24">
      ...
      <h4 className="text-2xl mr-60 ml-4 opacity-30">Understanding?</h4>
      <input className="text-2xl shadow-lg" onChange={getUnderstandData} type="number" placeholder="Rate: 1-10" />

      <button className="text-2xl mx-8 px-4 py-1 border-2 border-black rounded bg-green-200 hover:text-gray-200 hover:border-white hover:shadow-inner" onClick={sumbitData}>▶️</button>
    </div>
  );
}
